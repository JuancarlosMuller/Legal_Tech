...
.firmante1 {
        margin-left: 15%;
            ...
            <body>
                <div className="text" style={{ position: 'absolute', right: '0', marginTop: '1%' }}>
                    <img src={QR} alt="Código QR" width="50" height="50" />
                </div>
                ...
                <div className="text">
                    ...
                    <div className="text" style={{ position: 'absolute', right: '0', marginTop: '50%' }}>
                        <img src={QR} alt="Código QR" width="50" height="50" />
                    </div>
                    ...
                    <div className="text" style={{ position: 'absolute', right: '0', marginTop: '12%' }}>
                        <img src={QR} alt="Código QR" width="50" height="50" />
                    </div>
